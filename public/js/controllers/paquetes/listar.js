'use stric'
coreApp.controller('ListarPaquetesController', function ($scope, $window, ajax) {

    console.log("ListarPaquetesController");
    ...
    $scope.del = function(){
        ajax.Post("/paquetes/delpaquete/", {id:$scope.id_hotel_a_borrar} ).$promise.then(
            function(data) {
                if (data.success){
