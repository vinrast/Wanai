'use stric'
coreApp.controller('ListarBoletosController', function ($scope, $window, ajax) {

    console.log("ListarBoletosController");
    ...
    $scope.del = function(){
        ajax.Post("/boletos/delboleto/", {id:$scope.id_hotel_a_borrar} ).$promise.then(
            function(data) {
                if (data.success){
