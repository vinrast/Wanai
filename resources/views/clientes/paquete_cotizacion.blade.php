...
<div id="page-container" class="fade" ng-controller="PaquetesClienteCotizarController">
    ...
    <div class="content bg-silver-lighter">
        ...
        <div class="container">
            <br><br> 
           	...
           	<center><h1 class="page-header"><i class="fa fa-ticket"></i> Paquetes </h1></center>
			...
			<form class="form-horizontal" name="formulario" id="formulario" ng-submit="submit(formulario.$valid)" enctype="multipart/form-data" novalidate>
		        ...
		        <input type="hidden" name="i_paquete" value="{{ $id }}">
