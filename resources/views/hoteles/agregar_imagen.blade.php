...
@section('controller')
    <script src="{{ asset('/js/controllers/hoteles/agregar_imagen.js') }}"></script>
@endsection
...
<div ng-controller="uploadManyFiles">
    ...
    @include('layouts/sidebar')
        <div id="content" class="content">
            ...
            <h1 class="page-header"><i class="fa fa-bed"></i> Registrar Imágenes del Hotel </h1>
            <div>
                <div class="row" >
                        <div class="col-12 ui-sortable">
                            <div class="panel panel-inverse">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div ng-if="{{$data}}" ng-init="inicializar_objetos( {{ $data }}, '{{url('/uploads/hoteles/img_mid/')}}' )"></div>
