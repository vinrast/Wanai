...
<div ng-controller="WelcomeController">
    ...
    <div id="home" class="content has-bg home">
        ...
        <div class="content-bg">
            <img src="/img/home-bg.jpg" alt="Home" />
        </div>
        <!-- end content-bg -->
        <!-- begin container -->
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-6">
                    ...
                    <div class="about-author">
                        ...
                        <div class="author">
                            <div class="image">
                                <img src="/img/user-1.jpg" alt="Sean Ngu" />
                            </div>
                            <div class="info">
                                Sean Ngu
    ...
    <div id="milestone" class="content bg-black-darker has-bg" data-scrollview="true">
        <!-- begin content-bg -->
        <div class="content-bg">
            <img src="/img/milestone-bg.jpg" alt="Milestone" />
        </div>
        <!-- end content-bg -->
        <!-- begin container -->
        <div class="container">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-4">
                    ...
                    <div class="team">             
                        <div class="image" data-animation="true" data-animation-type="flipInX">
                            <img src="/img/user-1.jpg" alt="Ryan Teller" />
                        </div>
                        <div class="info">
                ...
                <div class="col-md-4 col-sm-4">
                    ...
                    <div class="team">             
                        <div class="image" data-animation="true" data-animation-type="flipInX">
                            <img src="/img/user-2.jpg" alt="Jonny Cash" />
                        </div>
                        <div class="info">
                ...
                <div class="col-md-4 col-sm-4">
                    ...
                    <div class="team">             
                        <div class="image" data-animation="true" data-animation-type="flipInX">
                            <img src="/img/user-3.jpg" alt="Mia Donovan" />
                        </div>
                        <div class="info">
    ...
    <div id="quote" class="content bg-black-darker has-bg" data-scrollview="true">
        <!-- begin content-bg -->
        <div class="content-bg">
            <img src="/img/quote-bg.jpg" alt="Quote" />
        </div>
        <!-- end content-bg -->
        <!-- begin container -->
    ...
    <div id="action-box" class="content has-bg" data-scrollview="true">
        <!-- begin content-bg -->
        <div class="content-bg">
            <img src="/img/action-bg.jpg" alt="Action" />
        </div>
        <!-- end content-bg -->
        <!-- begin container -->
        ...
        <div class="container" data-animation="true" data-animation-type="fadeInDown">
            ...
            <div class="row row-space-10">
                ...
                <div class="col-md-3 col-sm-6">
                    ...
                    <div class="work">
                        <div class="image">
                            <a href="#"><img src="/img/work-5.jpg" alt="Work 5" /></a>
                        </div>
                        <div class="desc">
                ...
                <div class="col-md-3 col-sm-6">
                    ...
                    <div class="work">
                        <div class="image">
                            <a href="#"><img src="/img/work-7.jpg" alt="Work 7" /></a>
                        </div>
                        <div class="desc">
            ...
            <div class="row row-space-10">
                ...
                <div class="col-md-3 col-sm-6">
                    ...
                    <div class="work">
                        <div class="image">
                            <a href="#"><img src="/img/work-6.jpg" alt="Work 6" /></a>
                        </div>
                        <div class="desc">
                ...
                <div class="col-md-3 col-sm-6">
                    ...
                    <div class="work">
                        <div class="image">
                            <a href="#"><img src="/img/work-8.jpg" alt="Work 8" /></a>
                        </div>
                        <div class="desc">
    ...
    <div id="client" class="content has-bg bg-green" data-scrollview="true">
        <!-- begin content-bg -->
        <div class="content-bg">
            <img src="/img/client-bg.jpg" alt="Client" />
        </div>
        <!-- end content-bg -->
        <!-- begin container -->
